...
class AuditLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create audit_log" do
    assert_difference('AuditLog.count') do
      post audit_logs_url, params: { audit_log: { ip_address: @audit_log.ip_address, path: @audit_log.path } }
    end
  ...
  test "should update audit_log" do
    patch audit_log_url(@audit_log), params: { audit_log: { ip_address: @audit_log.ip_address, path: @audit_log.path } }
